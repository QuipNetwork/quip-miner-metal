...
const ADVANTAGE2_MISSING_LABELS: [usize; 223] = [
    ...
    364, 370, 373, 376, 380, 381, 400, 406, 441, 451, 465, 484, 495, 496, 510, 518, 530, 534, 544, 555,
    556, 568, 570, 577, 585, 623, 630, 738, 753, 762, 769, 780, 790, 801, 817, 863, 880, 918, 972, 1008,
    1018, 1020, 1031, 1139, 1173, 1218, 1268, 1276, 1281, 1283, 1308, 1395, 1413, 1436, 1537, 1549, 1590, 1598, 1674, 1702,
    1842, 1844, 1845, 1866, 1871, 1895, 1913, 1979, 1993, 2002, 2004, 2049, 2072, 2111, 2123, 2149, 2171, 2230, 2355, 2377,
    2386, 2403, 2491, 2516, 2550, 2587, 2612, 2641, 2642, 2659, 2680, 2682, 2756, 2758, 2759, 2782, 2795, 2838, 2911, 2912,
    2926, 2927, 2940, 3060, 3108, 3110, 3112, 3122, 3198, 3205, 3206, 3212, 3218, 3225, 3240, 3252, 3253, 3264, 3265, 3266,
    3267, 3268, 3277, 3278, 3280, 3281, 3289, 3290, 3298, 3309, 3312, 3325, 3382, 3434, 3437, 3458, 3467, 3534, 3545, 3546,
    3551, 3651, 3698, 3705, 3722, 3792, 3796, 3827, 3888, 3953, 3961, 3985, 3997, 4058, 4071, 4082, 4083, 4119, 4120, 4121,
    4132, 4133, 4134, 4155, 4172, 4177, 4186, 4189, 4199, 4202, 4220, 4226, 4237, 4259, 4270, 4279, 4334, 4350, 4374, 4386,
    4388, 4393, 4412, 4424, 4447, 4450, 4476, 4508, 4575, 4579, 4604, 4608, 4641, 4650, 4684, 4686, 4720, 4723, 4725, 4761,
    4768, 4778, 4780,
];
...
fn advantage2_colors(graph: &IsingGraph) -> Option<Vec<usize>> {
    ...
    if graph.edges.iter().any(|&(u, v)| {
        u >= colors.len() || v >= colors.len() || colors[u] == colors[v]
    }) {
        return None;
    }
    Some(colors)
...
mod tests {
    ...
    fn advantage2_graph() -> IsingGraph {
        ...
        let edges: Vec<(usize, usize)> = fixture
            ...
            .map(|line| {
                let mut ids = line.split_whitespace().map(|id| id.parse().expect("node id"));
